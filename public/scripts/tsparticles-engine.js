...
!function(t, e) {
    ...
    t.d(e, {
        ...
        ParticlesDensity: () => Je,
        ParticlesInteractorBase: () => Vi,
        ParticlesNumber: () => Ke,
        ParticlesOptions: () => ui,
        Point: () => _i,
        Range: () => bi,
        RangedAnimationOptions: () => Ie,
        RangedAnimationValueWithRandom: () => Le,
        Rectangle: () => wi,
        ResizeEvent: () => ye,
        Responsive: () => ze,
        RgbColorManager: () => Li,
        ...
        calcExactPositionOrRandomFromSizeRanged: () => H,
        calcPositionFromSize: () => L,
        calcPositionOrRandomFromSize: () => F,
        calcPositionOrRandomFromSizeRanged: () => V,
        calculateBounds: () => it,
        circleBounce: () => ct,
        circleBounceDataFromParticle: () => ht,
        clamp: () => z,
        clear: () => Jt,
        collisionVelocity: () => A,
        colorMix: () => Ut,
        ...
        getHslFromAnimation: () => qt,
        getLinkColor: () => $t,
        getLinkRandomColor: () => Gt,
        getLogger: () => G,
        getParticleBaseVelocity: () => D,
    ...
    function R(t) {
        ...
        return O(i ? C(t.value, s) : t.value)
    }
    function T(t, e) {
        const i = t.x - e.x
          , s = t.y - e.y;
    ...
    function F(t) {
        return {
            x: (t.position?.x ?? 100 * x()) * t.size.width / 100,
            y: (t.position?.y ?? 100 * x()) * t.size.height / 100
        }
    }
    function V(t) {
        const e = {
            x: void 0 !== t.position?.x ? O(t.position.x) : void 0,
            y: void 0 !== t.position?.y ? O(t.position.y) : void 0
        };
        return F({
            size: t.size,
            position: e
    ...
    function B(t) {
        return {
            x: t.position?.x ?? x() * t.size.width,
            y: t.position?.y ?? x() * t.size.height
        }
    }
    function H(t) {
        const e = {
    ...
    function q(t) {
        ...
        return s.min < n.min || s.min > n.max || s.max < n.min || s.max > n.max || (i.max >= o.min && i.max <= (o.max + o.min) / 2 && a > 0 || i.min <= o.max && i.min > (o.max + o.min) / 2 && a < 0) && (e.velocity = a * -r,
        e.bounced = !0),
        e
    }
    function X() {
    ...
    function et(t, e, i, s) {
        let o = !0;
        return s && "bottom" !== s || (o = t.top < e.height + i.x),
    ...
    function st(t, ...e) {
        for (const i of e) {
            ...
            !e || !xt(t) && t && Array.isArray(t) ? e || !xt(t) && t && !Array.isArray(t) || (t = {}) : t = [];
            for (const e in i) {
                if ("__proto__" === e)
                    continue;
                const s = i[e]
                  , o = t;
                o[e] = xt(s) && Array.isArray(s) ? s.map((t => st(o[e], t))) : st(o[e], s)
            }
        }
        return t
    }
    ...
    function ht(t) {
        return {
            ...
            mass: t.getMass(),
            velocity: t.velocity,
            factor: v.create(R(t.options.bounce.horizontal), R(t.options.bounce.vertical))
        }
    }
    function ct(t, e) {
        ...
        if (i * a + s * r < 0)
            return;
        const h = -Math.atan2(r, a)
          , c = t.mass
          , l = e.mass
          , d = t.velocity.rotate(h)
          , u = e.velocity.rotate(h)
          , p = A(d, u, c, l)
          , f = A(u, d, c, l)
          , m = p.rotate(-h)
          , v = f.rotate(-h);
    ...
    function lt(t, e) {
        const i = it(t.getPosition(), t.getRadius())
          , s = q({
            ...
            factor: R(t.options.bounce.horizontal)
        });
        s.bounced && (void 0 !== s.velocity && (t.velocity.x = s.velocity),
        ...
        const o = q({
            ...
            factor: R(t.options.bounce.vertical)
        });
        o.bounced && (void 0 !== o.velocity && (t.velocity.y = o.velocity),
    ...
    function ft(t, e) {
        ...
        if (s.enable) {
            ...
            case "decrease":
                ...
                break;
            case "random":
                o.status = x() >= .5 ? "increasing" : "decreasing"
            }
            const t = "auto" === s.mode;
            switch (s.startValue) {
            case "min":
            ...
            default:
                o.value = P(o),
                t && (o.status = x() >= .5 ? "increasing" : "decreasing")
            }
        }
        return o.initialValue = o.value,
        o
    }
    function mt(t, e) {
        if (!("percent" === t.mode)) {
    ...
    function Tt(t, e, i=!0) {
        ...
        if (_t(s.value))
            return s.value === Mt ? Bt() : Lt(s.value);
        if (zt(s.value))
            return Tt({
                value: K(s.value, e, i)
            });
    ...
    function Dt(t) {
        ...
        return o !== n && (a.s = a.l < .5 ? (o - n) / (o + n) : (o - n) / (2 - o - n),
        a.h = e === o ? (i - s) / (o - n) : a.h = i === o ? 2 + (s - e) / (o - n) : 4 + (e - i) / (o - n)),
        a.l *= 100,
        a.s *= 100,
        a.h *= 60,
        a.h < 0 && (a.h += 360),
    ...
    function Bt(t) {
        const e = t ?? 0;
        return {
            b: Math.floor(P(C(e, 256))),
            g: Math.floor(P(C(e, 256))),
            r: Math.floor(P(C(e, 256)))
        }
    }
    function Ht(t, e) {
    ...
    function $t(t, e, i) {
            ...
            return i;
        {
            ...
            if (i && s && e)
                return Ut(i, s, t.getRadius(), e.getRadius());
            {
                const t = i ?? s;
                if (t)
                    return Ft(t)
    ...
    function Yt(t, e, i) {
        t.enable = e.enable,
        t.enable ? (t.velocity = O(e.speed) / 100 * i,
        t.decay = 1 - O(e.decay),
        t.status = "increasing",
        t.loops = 0,
        t.maxLoops = O(e.count),
        t.time = 0,
        t.delayTime = 1e3 * O(e.delay),
        e.sync || (t.velocity *= x(),
        t.value *= x()),
    ...
    function Kt(t) {
        const {container: e, context: i, particle: s, delta: o, colorStyles: n, backgroundMask: a, composite: r, radius: h, opacity: c, shadow: l, transform: d} = t
          , u = s.getPosition()
        ...
        l.enable && g && (i.shadowBlur = l.blur,
        i.shadowColor = Ht(g),
    ...
    class ae {
        constructor(t) {
            ...
            this._getPluginParticleColors = t => {
                ...
                for (const s of this._colorPlugins)
                    if (!e && s.particleFillColor && (e = Et(s.particleFillColor(t))),
                    !i && s.particleStrokeColor && (i = Et(s.particleStrokeColor(t))),
                    e && i)
                        break;
                return [e, i]
            }
            ...
            this._initCover = () => {
                ...
                if (e) {
                    ...
                    this._coverColorStyle = Ht(i, i.a)
                }
            }
            ,
            this._initStyle = () => {
                ...
                if (t) {
                    this._fullScreen ? (this._originalStyle = st({}, t.style),
        ...
        clear() {
            const t = this.container.actualOptions
              , e = t.particles.move.trail
              , i = this._trailFill;
            t.backgroundMask.enable ? this.paint() : e.enable && e.length > 0 && i ? i.color ? this._paintBase(Ht(i.color, i.opacity)) : i.image && this._paintImage(i.image, i.opacity) : this.draw((t => {
                Jt(t, this.size)
            }
            ))
        }
        ...
        drawParticle(t, e) {
            ...
            (n || a) && this.draw((s => {
                const o = this.container
                  , r = o.actualOptions
                  , h = t.options.zIndex
                  , c = (1 - t.zIndexFactor) ** h.opacityRate
                  , l = t.bubble.opacity ?? t.opacity?.value ?? 1
                  , d = l * c
                  , u = (t.strokeOpacity ?? l) * c
                  , p = {}
                  , f = {
                    fill: n ? Wt(n, d) : void 0
                };
                f.stroke = a ? Wt(a, u) : f.fill,
        ...
        initBackground() {
            ...
            if (i) {
                if (t.color) {
                    const e = Rt(t.color);
                    i.backgroundColor = e ? Ht(e, t.opacity) : ""
                } else
                    i.backgroundColor = "";
        ...
        paint() {
            const t = this.container.actualOptions;
            this.draw((e => {
                t.backgroundMask.enable && t.backgroundMask.cover ? (Jt(e, this.size),
    ...
    class he {
        constructor(t) {
            ...
            this._manageInteractivityListeners = (t, e) => {
                ...
                (a.interactivity.events.onHover.enable || a.interactivity.events.onClick.enable) && (re(u, r, i.mouseMove, e),
                re(u, h, i.touchStart, e),
                re(u, l, i.touchMove, e),
                a.interactivity.events.onClick.enable ? (re(u, c, i.touchEndClick, e),
                re(u, o, i.mouseUp, e),
                re(u, s, i.mouseDown, e)) : re(u, c, i.touchEnd, e),
            ...
            this._manageListeners = t => {
                const e = this._handlers
                  ...
                  , o = i.canvas.element;
                let r = n;
                "window" === s ? (i.interactivity.element = window,
                r = a) : i.interactivity.element = "parent" === s && o ? o.parentElement ?? o.parentNode : o,
            ...
            this._manageResize = t => {
                ...
                this._resizeObserver && !t ? (s && this._resizeObserver.unobserve(s),
                this._resizeObserver.disconnect(),
                delete this._resizeObserver) : !this._resizeObserver && t && s && (this._resizeObserver = new ResizeObserver((async t => {
            ...
            this._mouseTouchClick = t => {
                ...
                if (n && i.interactivity.events.onClick.enable) {
                    for (const [,t] of e.plugins)
                        if (t.clickPositionValid && (o = t.clickPositionValid(n),
                        o))
                            break;
    ...
    class le {
        ...
        load(t) {
            t && (void 0 !== t.color && (this.color = ce.create(this.color, t.color)),
    ...
    class _e {
        ...
        load(t) {
            ...
            yt(t.resize) ? this.resize.enable = t.resize : this.resize.load(t.resize)
        }
    }
    class be {
        constructor(t, e) {
    ...
    class Oe {
        ...
        load(t) {
            t && (void 0 !== t.count && (this.count = C(t.count)),
            void 0 !== t.enable && (this.enable = t.enable),
            void 0 !== t.offset && (this.offset = C(t.offset)),
            void 0 !== t.speed && (this.speed = C(t.speed)),
            void 0 !== t.decay && (this.decay = C(t.decay)),
            void 0 !== t.delay && (this.delay = C(t.delay)),
    ...
    class De {
        ...
        load(t) {
            t && (yt(t.random) ? this.random.enable = t.random : this.random.load(t.random),
            void 0 !== t.value && (this.value = C(t.value, this.random.enable ? this.random.minimumValue : void 0)))
        }
    }
    class Ae extends De {
        constructor() {
    ...
    class Le extends Ae {
        ...
        load(t) {
            ...
            !t)
                return;
            void 0 !== (t.animation ?? t.anim) && (this.value = C(this.value, this.animation.enable ? this.animation.minimumValue : void 0))
        }
    }
    class Fe extends De {
        constructor() {
    ...
    class Be {
        ...
        load(t) {
            ...
            void 0 !== t.enable && (this.enable = t.enable),
            void 0 !== t.maxSpeed && (this.maxSpeed = C(t.maxSpeed)),
            void 0 !== t.mode && (this.mode = t.mode),
    ...
    class He {
        ...
        load(t) {
            t && (void 0 !== t.offset && (this.offset = C(t.offset)),
            void 0 !== t.value && (this.value = C(t.value)))
        }
    }
    class We {
        constructor() {
        ...
        load(t) {
            if (!t)
                return;
            void 0 !== t.distance && (this.distance = C(t.distance)),
            void 0 !== t.enable && (this.enable = t.enable);
    ...
    class $e {
        ...
        load(t) {
            t && (void 0 !== t.acceleration && (this.acceleration = C(t.acceleration)),
            void 0 !== t.enable && (this.enable = t.enable),
    ...
    class Ne {
        ...
        load(t) {
            ...
            void 0 !== t.drift && (this.drift = C(t.drift)),
            void 0 !== t.enable && (this.enable = t.enable),
            this.gravity.load(t.gravity);
            const e = t.outModes ?? t.outMode ?? t.out_mode;
            void 0 !== e && (xt(e) ? this.outModes.load(e) : this.outModes.load({
                default: e
            })),
    ...
    class Ze extends Ie {
        ...
        load(t) {
            void 0 !== t?.opacity_min && void 0 === t.minimumValue && (t.minimumValue = t.opacity_min),
            super.load(t),
    ...
    class Qe extends De {
        ...
        load(t) {
            ...
            const e = t.animation ?? t.anim;
            void 0 !== e && (this.animation.load(e),
            this.value = C(this.value, this.animation.enable ? this.animation.minimumValue : void 0))
        }
    }
    class Je {
        constructor() {
    ...
    class hi extends Ie {
        ...
        load(t) {
            void 0 !== t?.size_min && void 0 === t.minimumValue && (t.minimumValue = t.size_min),
            super.load(t),
            t && void 0 !== t.destroy && (this.destroy = t.destroy)
        }
    }
    ...
    class li {
        ...
        load(t) {
            t && (void 0 !== t.color && (this.color = Se.create(this.color, t.color)),
            void 0 !== t.width && (this.width = C(t.width)),
            void 0 !== t.opacity && (this.opacity = C(t.opacity)))
        }
    }
    class di extends De {
        constructor() {
    ...
    class mi {
        ...
        load(t) {
            ...
            void 0 !== t.duration && (this.duration = C(t.duration));
    ...
    class yi {
        constructor(t, e, i, s, o, n) {
            ...
            this._calcPosition = (t, e, i, s=0) => {
                ...
                ;
                return h(r.left ?? r.default),
                h(r.right ?? r.default),
                c(r.top ?? r.default),
                c(r.bottom ?? r.default),
                this._checkOverlap(n, s) ? this._calcPosition(t, void 0, i, s + 1) : n
            }
            ,
            this._calculateVelocity = () => {
                const t = D(this.direction).copy()
                  , e = this.options.move;
                if ("inside" === e.direction || "outside" === e.direction)
                    return t;
                const i = Math.PI / 180 * O(e.angle.value)
                  , s = Math.PI / 180 * O(e.angle.offset)
                  , o = {
                    left: s - i / 2,
                    right: s + i / 2
                };
                return e.straight || (t.angle += P(C(o.left, o.right))),
                e.random && "number" == typeof e.speed && (t.length *= x()),
                t
            }
            ,
            this._checkOverlap = (t, e=0) => {
                ...
                return !!this.container.particles.find((e => I(t, e.position) < s + e.getRadius()))
            }
            ,
            ...
            this._initPosition = t => {
                ...
                this.direction = E(this.options.move.direction, this.position, this.moveCenter),
        ...
        getFillColor() {
            return this._getRollColor(this.bubble.color ?? qt(this.color))
        }
        getMass() {
        ...
        getStrokeColor() {
            return this._getRollColor(this.bubble.color ?? qt(this.strokeColor))
        }
        init(t, e, i, s) {
            const o = this.container
              , n = this._engine;
            ...
            const a = o.retina.pixelRatio
              , r = o.actualOptions
              , h = fi(this._engine, o, r.particles)
              , c = h.shape.type
              , {reduceDuplicates: l} = h;
            this.shape = ut(c, this.id, l);
            const d = h.shape;
            if (i && i.shape && i.shape.type) {
                const t = ut(i.shape.type, this.id, l);
                t && (this.shape = t,
                d.load(i.shape))
            }
            this.shapeData = this._loadShapeData(d, l),
            h.load(i);
            const u = this.shapeData;
            u && h.load(u.particles);
            const p = new we(n,o);
            p.load(o.actualOptions.interactivity),
            p.load(h.interactivity),
            this.interactivity = p,
            this.fill = u?.fill ?? h.shape.fill,
            this.close = u?.close ?? h.shape.close,
            this.options = h;
            const f = this.options.move.path;
            this.pathDelay = 1e3 * R(f.delay),
            f.generator && (this.pathGenerator = this._engine.plugins.getPathGenerator(f.generator),
            this.pathGenerator && o.addPath(f.generator, this.pathGenerator) && this.pathGenerator.init(o)),
            ...
            this.moveDecay = 1 - O(this.options.move.decay);
            const m = o.particles;
            ...
            v || (v = this._engine.plugins.getShapeDrawer(this.shape),
            v && o.drawers.set(this.shape, v)),
            v && v.loadShape && v.loadShape(this);
            const g = v?.getSidesCount;
            g && (this.sides = g(this)),
            this.spawning = !1,
            this.shadowColor = Rt(this.options.shadow.color);
            for (const t of o.particles.updaters)
                t.init(this);
            for (const t of o.particles.movers)
                t.init && t.init(this);
            v && v.particleInit && v.particleInit(o, this);
    ...
    class wi extends bi {
        ...
        intersects(t) {
            t instanceof xi && t.intersects(this);
            const e = this.size.width
              , i = this.size.height
              , s = this.position
              , o = t.position
              , n = t instanceof wi ? t.size : {
                width: 0,
                height: 0
            }
              , a = n.width
    ...
    class zi {
        constructor(t, e) {
            ...
            this._subdivide = () => {
                const {x: t, y: e} = this.rectangle.position
                  ...
                  , {capacity: o} = this;
                for (let n = 0; n < 4; n++)
                    this._subs.push(new zi(new wi(t + i / 2 * (n % 2),e + s / 2 * (Math.round(n / 2) - n % 2),i / 2,s / 2),o));
                this._divided = !0
            }
            ,
            this._points = [],
        ...
        query(t, e, i) {
            ...
            for (const i of this._points)
                !t.contains(i.position) && I(t.position, i.position) > i.particle.getRadius() && (!e || e(i.particle)) || s.push(i.particle);
            if (this._divided)
        ...
        queryCircle(t, e, i) {
            return this.query(new xi(t.x,t.y,e), i)
        }
        queryRectangle(t, e, i) {
            return this.query(new wi(t.x,t.y,e.width,e.height), i)
        }
    }
    const Mi = t => new wi(-t.width / 4,-t.height / 4,3 * t.width / 2,3 * t.height / 2);
    class Pi {
        constructor(t, e) {
            this._applyDensity = (t, e, i) => {
                ...
                const s = t.number
                  ...
                  , r = Math.min(n, a) * o + e
                  , h = Math.min(this.count, this.filter((t => t.group === i)).length);
                this.limit = s.limit * o,
                h < r ? this.push(Math.abs(r - h), void 0, t, i) : h > r && this.removeQuantity(h - r, i)
            }
            ,
            ...
            this.needsSort = !1,
            this.lastZIndex = 0,
            this._interactionManager = new vi(t,e);
        ...
        init() {
            ...
            !i) {
                for (const t in e.particles.groups) {
                    ...
                    for (let s = this.count, o = 0; o < i.number?.value && s < e.particles.number.value; s++,
                    o++)
        ...
        async update(t) {
            ...
            for (const s of this._array) {
                ...
                o && !s.ignoresResizeRatio && (s.position.x *= o.width,
                ...
                s.destroyed ? i.add(s) : this.quadTree.insert(new _i(s.getPosition(),s))
            }
            if (i.size) {
                const t = t => !i.has(t);
    ...
    class Oi {
        ...
        init() {
            const t = this.container
              , e = t.actualOptions;
            this.pixelRatio = !e.detectRetina || X() ? 1 : window.devicePixelRatio,
            this.reduceFactor = 1;
            ...
            const s = e.particles
              , o = s.move;
            this.attractDistance = O(o.attract.distance) * i,
            this.maxSpeed = O(o.gravity.maxSpeed) * i,
            this.sizeAnimationSpeed = O(s.size.animation.speed) * i
        }
        initParticle(t) {
            const e = t.options
              , i = this.pixelRatio
              ...
              , o = s.distance
              , n = t.retina;
            n.attractDistance = O(s.attract.distance) * i,
            n.moveDrift = O(s.drift) * i,
            n.moveSpeed = O(s.speed) * i,
            n.sizeAnimationSpeed = O(e.size.animation.speed) * i;
            ...
            n.maxSpeed = O(s.gravity.maxSpeed) * i
        }
    }
    function ki(t) {
    ...
    class Ri {
        constructor(t, e, i) {
            ...
            this._intersectionManager = t => {
                if (ki(this) && this.actualOptions.pauseOnOutsideViewport)
                    for (const e of t)
            ...
            this._eventListeners = new he(this),
            ...
            e.addEventListener("touchend", (t => {
                if (ki(this)) {
                    if (s && !o) {
                        ...
                        if (!s && (s = e.changedTouches[e.changedTouches.length - 1],
                        !s))
                            return;
        ...
        addPath(t, e, i=!1) {
            return !(!ki(this) || !i && this.pathGenerators.has(t)) && (this.pathGenerators.set(t, e ?? Ci),
            !0)
        }
        alive() {
        ...
        getAnimationStatus() {
            return !this._paused && !this.pageHidden && ki(this)
        }
        handleClickMode(t) {
            if (ki(this)) {
        ...
        async init() {
            ...
            this._duration = 1e3 * O(this.actualOptions.duration),
            this._delay = 1e3 * O(this.actualOptions.delay),
            this._lifeTime = 0,
        ...
        async loadTheme(t) {
            ki(this) && (this._currentTheme = t,
            await this.refresh())
        }
        pause() {
            if (ki(this) && (void 0 !== this._drawAnimationFrame && (cancelAnimationFrame(this._drawAnimationFrame),
        ...
        async start() {
            ki(this) && !this.started && (await this.init(),
            this.started = !0,
            await new Promise((t => {
    ...
    function Ii(t, e, i, s=!1) {
        let o = e.get(t);
        return o && !s || (o = [...i.values()].map((e => e(t))),
        e.set(t, o)),
        o
    }
    class Ei {
    ...
    class Di {
        ...
        async loadFromArray(t, e, i) {
            ...
            _t(t) ? s.id = t : s.options = t,
            bt(e) ? s.index = e : s.options = e ?? s.options,
            s.index = i ?? s.index) : s = t,
            this._loadParams(s)
        }
        async loadJSON(t, e, i) {
            let s, o;
            return bt(e) || void 0 === e ? s = t : (o = t,
            s = e),
            this._loadParams({
                id: o,
                url: s,
        ...
        async set(t, e, i, s) {
            ...
            return _t(t) ? o.id = t : o.element = t,
        ...
        async setJSON(t, e, i, s) {
            const o = {};
            return t instanceof HTMLElement ? (o.element = t,
            o.url = e,
            o.index = i) : (o.id = t,
            o.element = e,
            o.url = i,
        ...
        async _loadParams(t) {
            const e = t.id ?? `tsparticles${Math.floor(1e4 * x())}`
              , {index: s, url: o} = t
              , n = o ? await async function(t) {
                ...
                return i.ok ? i.json() : (G().error(`${f} ${i.status} while retrieving config file`),
                t.fallback)
            }({
                fallback: t.options,
                url: o,
            ...
            if ("canvas" === a.tagName.toLowerCase())
                ...
                t.length ? (l = t[0],
                l.dataset[i] = "false") : (l = document.createElement("canvas"),
                l.dataset[i] = "true",
                a.appendChild(l))
            }
            l.style.width || (l.style.width = "100%"),
            l.style.height || (l.style.height = "100%");
            const d = new Ri(this,e,r);
            return c >= 0 ? h.splice(c, 0, d) : h.push(d),
    ...
    return X() || (window.tsParticles = Bi),
    e
}
)()));
