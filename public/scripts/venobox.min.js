    ...
    */
    ...
    function ne(e) {
        if (Q) {
            ...
            N > 0 && w && (e = j,
            t = !0),
            Math.abs(N) >= 50 && t ? le(e) : (a.style.marginLeft = 0,
            a.style.opacity = 1)
        }
    }
    function se(e) {
    ...
    function de(l) {
        ...
        re(),
        l.settings.navKeyboard && (document.body.addEventListener("keydown", J),
